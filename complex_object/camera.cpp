...
/******************************************************************/
/*
Purpose: changes the camera's position along the Upvector


Descripton: move the camera up by the numUnits along theUpVector
...
Descripton: move the camera down by the numUnits along the upVector
